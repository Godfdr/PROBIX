...
export function ProbixLogo({ size = 'md' }: { size?: 'sm' | 'md' | 'lg' }) {
  ...
  return (
      <div className={`${scales[size]} relative group`}>
          ...
          {/* Inner "P" Shape Core */}
          <div className="absolute inset-[10%] bg-[#0A0C12] dark:bg-[#0A0C12] rounded-xl shadow-[0_0_20px_rgba(59,130,246,0.4)] flex items-center justify-center overflow-hidden border border-primary/40">
